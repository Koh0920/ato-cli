...
- Satisfy security audit for capsule-core release

- Ignore shadow manifests in nacelle lookup

- Reuse existing uv.lock in lockfile generation
...
- Support single-file javascript and jsx scripts

- Support single-file tsx run with deno

- Support single-file typescript run with deno

- Support single-file python run
...
- Merge dev into main after fixing build job

- Refactor lock-native execution and extract draft engine
